...
%% 账户状态
% 正常
-define(ACCOUNT_STATUS_NORMAL, 0).
% 临时封号 有时效性，默认1小时
...
%% 货币对应的itemid,写程序方便，货币不是道具，玩家背包里不会出现道具
-define(ITEM_GOLD_TYPE_ID, 210012).
-define(ITEM_DIAMOND_TYPE_ID, 210015).
-define(ITEM_HOURGLASS_TYPE_ID, 210016).
-define(ITEM_SOUL_TYPE_ID, 210011).
-define(ITEM_KNOW_TYPE_ID, 210014).
-define(ITEM_MONEY_ID_LIST, [
	?ITEM_GOLD_TYPE_ID, ?ITEM_DIAMOND_TYPE_ID, 
	?ITEM_HOURGLASS_TYPE_ID, ?ITEM_SOUL_TYPE_ID, 
	?ITEM_KNOW_TYPE_ID]).
